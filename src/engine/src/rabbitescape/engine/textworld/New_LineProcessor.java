...
public class LineProcessor
{
        ...
        char c, int x, int y, VariantGenerator variantGen )
    {
	    ...
	    //TODO: Create RabbitFactory
            case 'r':
            {
                AbstractRabbit r = new Rabbit( x, y, RIGHT, Rabbit.Type.RABBIT );
                ret = r;
                rabbits.add( r );
                break;
            }
            case 'j':
            {
                AbstractRabbit r = new Rabbit( x, y, LEFT, Rabbit.Type.RABBIT );
                ret = r;
                rabbits.add( r );
                break;
            }
            case 't':
            {
                AbstractRabbit r = new Rabbit( x, y, RIGHT, Rabbit.Type.RABBOT );
                ret = r;
                rabbits.add( r );
                break;
            }
            case 'y':
            {
                AbstractRabbit r = new Rabbit( x, y, LEFT, Rabbit.Type.RABBOT );
                ret = r;
                rabbits.add( r );
                break;
            }
